...
class Graf:
    ...
    def estimeaza_h(self,infoNod):
        return max((ceil(infoNod[0]+infoNod[1]/(Graf.M-1))*2-1),0)
        #return ceil((infoNod[0]+infoNod[1])/Graf.M)    #ceil pentru a rotunji in sus   imbunatateste formula
